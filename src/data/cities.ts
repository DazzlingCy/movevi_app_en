...
export const CITIES: CityData[] = [
  { id: '1', name: 'Hangzhou', englishName: 'Hangzhou', continent: 'China', x: 83.5, y: 33.8, lat: 30.2741, lng: 120.1551, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/%E6%9D%AD%E5%B7%9E%E9%92%B1%E6%B1%9F%E6%96%B0%E5%9F%8E_4_%28cropped%29.jpg/1280px-%E6%9D%AD%E5%B7%9E%E9%92%B1%E6%B1%9F%E6%96%B0%E5%9F%8E_4_%28cropped%29.jpg', routes: 3, spots: 24, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'bottom', description: 'The starting point of awakening memories. From the poetic West Lake to the modern Qianjiang New Town, feel the blend of ancient culture and future tech.' },
  { id: '2', name: 'Beijing', englishName: 'Beijing', continent: 'China', x: 82.33, y: 27.83, lat: 39.9042, lng: 116.4074, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2d/Skyline_of_Beijing_CBD_with_B-5906_approaching_%2820211016171955%29_%281%29.jpg/1280px-Skyline_of_Beijing_CBD_with_B-5906_approaching_%2820211016171955%29_%281%29.jpg', routes: 3, spots: 15, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'top', description: 'Ancient imperial majesty runs in sync with a modern metropolis. Traverse the historic central axis and light up the heart of Chinese civilization.' },
  { id: '3', name: 'Shanghai', englishName: 'Shanghai', continent: 'China', x: 84.8, y: 32.5, lat: 31.2304, lng: 121.4737, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Huangpu_Park_20124-Shanghai_%2832208802494%29.jpg/1280px-Huangpu_Park_20124-Shanghai_%2832208802494%29.jpg', routes: 3, spots: 83, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'right', description: 'Where neon lights gleam by the Huangpu River. The historic architecture and the futuristic Lujiazui skyline capture the timeless passage of eras.' },
  { id: '4', name: 'Nanjing', englishName: 'Nanjing', continent: 'China', x: 82.5, y: 31.8, lat: 32.0603, lng: 118.7969, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/82/Nanjing_CBD_from_City_Wall.jpg/1280px-Nanjing_CBD_from_City_Wall.jpg', routes: 3, spots: 71, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'left', description: 'A dream of Jinling, capital of six ancient dynasties. Poetic river lantern ripples, towering mountain mausoleums, and majestic historical landscapes.' },
  { id: '5', name: 'Xi\'an', englishName: 'Xi\'an', continent: 'China', x: 80.25, y: 30.94, lat: 34.3416, lng: 108.9398, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/City_wall_of_Xi%27an_51550-Xian_%2827959363326%29.jpg/1280px-City_wall_of_Xi%27an_51550-Xian_%2827959363326%29.jpg', routes: 3, spots: 66, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'left', description: 'The ancient capital of Chang\'an, home of the Terracotta Army and the Great Wild Goose Pagoda. The millennium-old beginning of the legendary Silk Road.' },
  { id: '6', name: 'Tokyo', englishName: 'Tokyo', continent: 'Asia', x: 88.80, y: 30.16, lat: 35.6762, lng: 139.6503, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Skyscrapers_of_Shinjuku_2009_January.jpg/1280px-Skyscrapers_of_Shinjuku_2009_January.jpg', routes: 3, spots: 120, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'right', description: 'Cherry blossoms, the iconic Tokyo Tower, and bustling street crossings. A super-metropolis where anime culture collides with ancient shrines.' },
  ...
  { id: '8', name: 'London', englishName: 'London', continent: 'Europe', x: 49.3, y: 21.0, lat: 51.5072, lng: -0.1276, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/London_Skyline_%28125508655%29.jpeg/1280px-London_Skyline_%28125508655%29.jpeg', routes: 3, spots: 140, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'top', description: 'Hear the toll of Big Ben echoing across the Thames. Explore West End theatres, foggy cobblestone streets, and the historic footprints of an empire.' },
  { id: '9', name: 'New York', englishName: 'New York', continent: 'North America', x: 29.44, y: 27.38, lat: 40.7128, lng: -74.006, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/View_of_Empire_State_Building_from_Rockefeller_Center_New_York_City_dllu_%28cropped%29.jpg/1280px-View_of_Empire_State_Building_from_Rockefeller_Center_New_York_City_dllu_%28cropped%29.jpg', routes: 3, spots: 110, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'top', description: 'The skyscrapers of the Big Apple, the endless neon glow of Times Square, and the Statue of Liberty greeting runners in the world\'s vibrant melting pot.' },
  { id: '10', name: 'Sydney', englishName: 'Sydney', continent: 'Oceania', x: 92.00, y: 68.83, lat: -33.8688, lng: 151.2093, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/53/Sydney_Opera_House_and_Harbour_Bridge_Dusk_%282%29_2019-06-21.jpg/1280px-Sydney_Opera_House_and_Harbour_Bridge_Dusk_%282%29_2019-06-21.jpg', routes: 3, spots: 85, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'right', description: 'The jewel of the Southern Hemisphere. Run past the sails of the Sydney Opera House and the sparkling waves of Darling Harbour.' },
  { id: '11', name: 'Rio', englishName: 'Rio', continent: 'South America', x: 38.00, y: 62.72, lat: -22.9068, lng: -43.1729, image: 'https://upload.wikimedia.org/wikipedia/6/62/Praia_de_Copacabana_-_Rio_de_Janeiro%2C_Brasil.jpg', routes: 3, spots: 50, completed: 0, status: 'upcoming', completedRouteIndices: [], labelPosition: 'right', description: 'Stunning bays overlooked by the Christ the Redeemer statue, the passion of Copacabana Beach, and the energetic rhythm of Samba and tropical sun.' },
  { id: '12', name: 'Cairo', englishName: 'Cairo', continent: 'Africa', x: 58.66, y: 33.33, lat: 30.0444, lng: 31.2357, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/Cairo_Opera_House%2C_Al_Hurriyah_Park_and_the_Nile_river_%2814797782354%29.jpg/1280px-Cairo_Opera_House%2C_Al_Hurriyah_Park_and_the_Nile_river_%2814797782354%29.jpg', routes: 3, spots: 60, completed: 0, status: 'upcoming', completedRouteIndices: [], labelPosition: 'right', description: 'Ancient pyramids standing by the Nile and the thousand-year riddle of the Sphinx. Discover ancient secrets and golden desert majesty.' },
  { id: '13', name: 'Bangkok', englishName: 'Bangkok', continent: 'Asia', x: 75.4, y: 46.5, lat: 13.7563, lng: 100.5018, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4d/Wat_Arun_Ratchawararam_Ratchawaramahawihan%2C_Bangkok.jpg/1280px-Wat_Arun_Ratchawararam_Ratchawaramahawihan%2C_Bangkok.jpg', routes: 3, spots: 72, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'right', description: 'Temple spires, river boats, night markets, and warm city motion light the Bangkok route.' },
  { id: '14', name: 'Mumbai', englishName: 'Mumbai', continent: 'Asia', x: 68.6, y: 43.4, lat: 19.076, lng: 72.8777, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Mumbai_Skyline_at_Night.jpg/1280px-Mumbai_Skyline_at_Night.jpg', routes: 3, spots: 96, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'left', description: 'Arabian Sea breeze, colonial gateways, and Bollywood color drive Mumbai\'s route pulse.' },
  { id: '15', name: 'Singapore', englishName: 'Singapore', continent: 'Asia', x: 78.3, y: 52.2, lat: 1.3521, lng: 103.8198, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/16/Marina_Bay_Singapore-3499.jpg/1280px-Marina_Bay_Singapore-3499.jpg', routes: 3, spots: 88, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'right', description: 'A garden city route through Marina Bay, tropical parks, and clean future-facing streets.' },
  { id: '16', name: 'Moscow', englishName: 'Moscow', continent: 'Europe', x: 61.5, y: 20.5, lat: 55.7558, lng: 37.6173, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Moscow_July_2011-16.jpg/1280px-Moscow_July_2011-16.jpg', routes: 3, spots: 78, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'top', description: 'Domes, broad avenues, and river embankments give Moscow a dramatic northern route signal.' },
  { id: '17', name: 'Los Angeles', englishName: 'Los Angeles', continent: 'North America', x: 17.2, y: 38.4, lat: 34.0522, lng: -118.2437, image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/5/57/Los_Angeles_with_Mount_Baldy.jpg/1280px-Los_Angeles_with_Mount_Baldy.jpg', routes: 3, spots: 104, completed: 0, status: 'unlit', completedRouteIndices: [], labelPosition: 'left', description: 'From palm-lined streets to Griffith views, Los Angeles runs between city glow and Pacific light.' },
];
...
export const getRouteData = (cityId: string, routeIndex: number): RouteDetailConfig => {
  ...
  const routeConfigs: Record<string, RouteDetailConfig[]> = {
    ...
    '7': [ // Paris
      { title: 'Sunset on the Seine', distance: '6.5', duration: '45:00', calories: '410', rating: '5.0', spots: 'Louvre Museum  - Pont Neuf  - Musee d\'Orsay', intro: 'Run with the river breeze as the sunset paints the clock tower of Musee d\'Orsay in gold. Truly the most romantic run in Paris.' },
      { title: 'Eiffel Tower Stars', distance: '3.0', duration: '20:00', calories: '180', rating: '4.8', spots: 'Champ de Mars  - Eiffel Tower  - Trocadero', intro: 'Sprint under the sparkling towers of the Eiffel Tower, traversing Champ de Mars. Experience the heartbeat of the City of Light.' }
    ],
    '8': [ // London
